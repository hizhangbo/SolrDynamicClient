...
import web.authorization.model.ResultMsg;
import web.authorization.model.ResultStatusCode;
...
public class HTTPBasicAuthorizeAttribute implements Filter{
    ...
    public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain)
        ...
        if (resultStatusCode != ResultStatusCode.OK)
        {
            ...
            ResultMsg resultMsg = new ResultMsg(ResultStatusCode.PERMISSION_DENIED.getErrcode(), ResultStatusCode.PERMISSION_DENIED.getErrmsg());
